import { delLink, listLink } from '@/api/content/link';
    ...
    },
    {
      ...
      render: (text) =>
        text === '0' ? (
          ...
          <Tag color='#f70808'>审核未通过</Tag>
        ) : (
          <Tag color='#696955'>未审核</Tag>
        ),
    },
    {
      title: '操作',
    ...
    <div className='viewBox'>
      <Form form={form}>
        <Row className={styles.btnBox}>
          <Col span={6}>
            <Form.Item name='name' label='名称' className='searchItem'>
              <Input placeholder='请输入' allowClear />
            </Form.Item>
          </Col>
          <Col span={6}>
            <Form.Item name='status' label='审核状态' className='searchItem'>
              <Select
                placeholder='请选择'
                options={[
                  { label: '审核通过', value: '0' },
